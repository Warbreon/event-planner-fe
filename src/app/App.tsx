...
import ROUTES from '../routes/routes'; // Use the imported ROUTES from your colleague's version
...
import Main from '../pages/main/Main'; // Use the imported Main component from your colleague's version
