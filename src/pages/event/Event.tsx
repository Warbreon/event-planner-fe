...
const Event = () => {
	...
	const { onAddGuestsClick, onEventRegistrationClick, eventChangePrivelege, event, isLoading, location, eventDate, startTime, endTime, duration } =
		EventPageVM();
			...
			<Grid container spacing={2} className={styles.gridContainer}>
				<Grid item xs={8} className={styles.gridItem}>
					<Box component='section' className={styles.desciption}>
						...
						<EventPageGuests onAddGuests={onAddGuestsClick} attendees={attendees} eventChangePrivelege={eventChangePrivelege}/>
						<Image styles='event-page' imageUrl={imageUrl} />
						<TabComponent address={address} description={description} tags={tags} agenda={agenda} attendees={attendees} eventChangePrivelege={eventChangePrivelege} />
					</Box>
				</Grid>
